...
public class Tablerojframe extends javax.swing.JFrame {
     ...
     */
    private final OpcionesPartida parent;
    private final Jugador jugador = new Jugador();
    private final String dificultad;
    private final Personaje personajes[][];
    private final ArrayList<Integer> turnosGeneracionZombies;
    private int zombiesTotales;
    private final Random zombieTurno = new Random();
     ...
     * @param dni es el dni asociado al usuario
     */
    public Tablerojframe(OpcionesPartida op, int f, int c, Object dif, String dni) {
        ...
        girasol.setIcon(new ImageIcon("Girasol.png"));
        girasol.setBounds(0, 0, 61, 42);
        jLabelImagenGirasol.add(girasol);

        JLabel langui = new JLabel();
        langui.setIcon(new ImageIcon("Lanzaguistantes.png"));
        langui.setBounds(0, 0, 61, 42);
        jLabelImagenLanzaguisantes.add(langui);
        
        JLabel fruta = new JLabel();
        fruta.setIcon(new ImageIcon("FrutaEstrella.png"));
        fruta.setBounds(0, 0, 61, 42);
        jLabelImagenFrutaEstrella.add(fruta);
        
        JLabel col = new JLabel();
        col.setIcon(new ImageIcon("ColBoxeadora.png"));
        col.setBounds(0, 0, 61, 42);
        jLabelImagenColboxeadora1.add(col);
        
        JLabel cereza = new JLabel();
        cereza.setIcon(new ImageIcon("PetaCereza.png"));
        cereza.setBounds(0, 0, 61, 42);
        jLabelImagenPetacereza.add(cereza);
        
        JLabel nuez = new JLabel();
        nuez.setIcon(new ImageIcon("Nuez.png"));
        nuez.setBounds(0, 0, 61, 42);
        jLabelImagenNuez.add(nuez);
...
// Matriz doble donde se almacenan los personajes de la partida
        ...
        partida = new Partida(dificultad, HashUsuarios.getLista().get(dni).getNombre());
    ...
    private void initComponents() {
        ...
        jLabelImagenNuez = new javax.swing.JLabel();
        jLabelImagenPetacereza = new javax.swing.JLabel();
        jLabelImagenColboxeadora1 = new javax.swing.JLabel();
        jButtonNuez1 = new javax.swing.JButton();
        ...
        jButtonNuez1.setFont(new java.awt.Font("MV Boli", 1, 11)); // NOI18N
        jButtonNuez1.setText("Nuez (50)");
        jButtonNuez1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonNuez1ActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(42, 42, 42))
                            .addComponent(jButtonGirasol, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(85, 85, 85)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jButtonNuez1)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(jLabelImagenNuez, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(15, 15, 15)))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(42, 42, 42)
                                ...
                                .addGap(81, 81, 81)
                                .addComponent(jLabelImagenColboxeadora1, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(106, 106, 106)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                            ...
                            .addGap(19, 19, 19))
                        .addComponent(jLabelImagenColboxeadora1, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabelImagenFrutaEstrella, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabelImagenNuez, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                if (personajes[i][j] instanceof Zombie) {
                    ...
                    if (!atacar) {
                        ...
                        try {
                            ...
                            pd.setVisible(true);                           
                            HashUsuarios.cargarDatos();
                            HashMap<String, Usuario> lista = HashUsuarios.getLista();
                            Usuario u;
                            u = (Usuario) lista.get(dni);
                            u.setDerrotas(u.getDerrotas() + 1);
                            u.añadirPartida(partida);
//                            HashUsuarios.getLista().replace(dni, u);
                            HashUsuarios.guardarDatos();
                            this.dispose();
...
// Si el marcador llega a 0, ganas la partida y finaliza la partida
    ...
    private void jButtonNuez1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNuez1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jButtonNuez1ActionPerformed
    ...
    private javax.swing.JButton jButtonNuez1;
    ...
    private javax.swing.JLabel jLabelImagenColboxeadora1;
    ...
    private javax.swing.JLabel jLabelImagenNuez;
